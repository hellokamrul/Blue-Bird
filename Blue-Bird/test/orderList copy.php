            ...
            <table align="center" border="1" width="1500px">
                <tr>
                    ...
                    <?php
                        ...
                        $sql = "SELECT p.pid, p.name, p.price, p.desc, c.qnty 
                                FROM cart c
                        ...
                        if ($result && mysqli_num_rows($result) > 0) {
                           // echo "<table>";
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr><td>".$row['pid']."</td><td>".$row['name']."</td><td>".$row['price']."</td><td>".$row['desc']."</td><td>".$row['qnty']."</td></tr>";
                            }
                            //echo "</table>";
                        } else {
